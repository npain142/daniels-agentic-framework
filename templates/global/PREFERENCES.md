...
- After a session task with committable changes, end the **task summary** with **Suggested commit message:** and a fenced code block containing only the message (copyable; imperative; do not commit unless asked).
