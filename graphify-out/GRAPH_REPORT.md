...
## Corpus Check
- 98 files · ~25,605 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 803 nodes · 1198 edges · 60 communities (49 shown, 11 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `12cc2dae`
...
- `Scaffold` --references--> `AGENTS.md (scaffold)`  [INFERRED]
  .agent/GLOSSARY.md → templates/global/scaffold/AGENTS.md
...
Cohesion: 0.07
Nodes (43): Platform (IDE), installClaudeGlobalSkills(), CODEX_AGENTS_MARKERS, installCodexGlobalAgents(), buildSkillMdBody(), installCursorGlobalSkills(), installFlatMarkdownSkills(), loadSkillManifest() (+35 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (50): /daf-phase-transition includes KG bootstrap, Architecture — DAF monorepo, Boundaries, Code graph layer, Data flow, Domain graph layer, KG scripts (kg-bootstrap.mjs, kg-ingest.mjs), Knowledge graph (Graphify) (+42 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (45): verify-state.json, check, Codebase Check, taskCheck, fingerprints, AGENTS.md, ARCHITECTURE.md, GLOSSARY.md (+37 more)

### Community 3 - "Community 3"
Cohesion: 0.13
Nodes (19): grill-me, description, name, help, description, name, pivot, description (+11 more)
...
Cohesion: 0.06
Nodes (30): Backlog, Logback, Architecture anchors, Codebase snapshot, Drift / cleanup candidates, Learnings, Stack constraints, Standing rules (+22 more)
...
Cohesion: 0.08
Nodes (33): Phase: maintaining, Assumption audit (planning — gate before PRD), Before the first question (planning), Before the first question (realignment), Context load (all phases), Skill: /daf-grill-me, Developing / maintaining — realignment, Hard rules (planning) (+25 more)

### Community 14 - "Community 14"
Cohesion: 0.11
Nodes (18): backlog-add, description, name, backlog-work, description, name, how-it-works, description (+10 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (49): 1. Two pillars, 2.1 KG-first canon (when the graph exists), 2. Load order (every session), 3. Layout (lean), 4. Skills (v1), 5. Always-on rules, 6. For humans, AGENTS.md (project) (+41 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (35): Phase: planning, Architecture (starter), Boundaries, Modules, Architecture (starter), codebaseEvery, defaultBranch, Global setup (+27 more)
...
Cohesion: 0.10
Nodes (27): Codebase-check (two phases), Phase: developing, Skill: /daf-help, Sections (use these headings), Skill: /daf-help, Skills table (v1), Steps, Stop condition (+19 more)

### Community 19 - "Community 19"
Cohesion: 0.67
Nodes (3): discuss, description, name
...
Cohesion: 0.67
Nodes (3): new-feature, description, name
...
Cohesion: 0.67
Nodes (3): onboard, description, name

### Community 32 - "Community 32"
Cohesion: 0.67
Nodes (3): remember, description, name
...
## Knowledge Gaps
- **312 isolated node(s):** `phase`, `stack`, `taskCheck`, `check`, `codebaseEvery` (+307 more)
...
- **Why does `platforms.json` connect `Community 15` to `Community 0`, `Community 1`, `Community 10`?**
