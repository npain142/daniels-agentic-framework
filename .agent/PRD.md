...
- **IDE skills:** `/daf-onboard`, `/daf-setup`, `/daf-help`, `/daf-grill-me`, `/daf-start`, `/daf-how-it-works`, `/daf-ltm-checkup`, `/daf-new-feature`, `/daf-issue`, `/daf-improvement`, `/daf-pivot`, `/daf-discuss`, `/daf-backlog-add`, `/daf-backlog-work`, `/daf-remember`, `/daf-retro`, `/daf-phase-transition`, `/daf-remove`, `/daf-remove-global`.
