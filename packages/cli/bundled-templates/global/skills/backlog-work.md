...
1. Read repo-root **`BACKLOG.md`**. List items under **`## Open`** (numbered, `#p1` first). If **`## In progress`** has a line, treat it as the active item or ask once whether to continue it.
